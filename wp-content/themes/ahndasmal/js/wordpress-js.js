(function( $, window ) {
    var _defaults = {
        ...
        speed   : 1500 // time to clear all times
    };
...
jQuery(document).ready(function ($) {
    $( "#showCategories" ).click(function() {
        $('.categoryName').slideToggle("slow");
        $('#showCategories').toggleClass('actionActive');
    });

    if ($(window).width() <= 480) {  
        $('article').removeClass('col-xs-6');
        $('article').addClass('col-xs-12');
    }
...
// $( ".showCategories" ).c#articleCatck(function() {
